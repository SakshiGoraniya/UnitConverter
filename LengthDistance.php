...
<body>
    ...
    <h1 style="text-align:center">Convertion Of Length</h1>
    <div class="container"><form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        <div class="set">
            <label for="fromConvertionUnit">From:</label>
            <input class="form-control" type="number" name="Lenght" id="Lenght" value="<?php echo (!empty($Lenght)) ? $Lenght : '' ?>">
